...
public class BlueService extends Service implements BluetoothSppHelper.BlueSocketListener {
    ...
    public static final String ACTION_MESSAGE_REVEIVER = "android.fise.com.bluetoothhelper.socket.message.receiver";
    public static final String ACTION_MESSAGE_SEND = "android.fise.com.bluetoothhelper.socket.message.send";
