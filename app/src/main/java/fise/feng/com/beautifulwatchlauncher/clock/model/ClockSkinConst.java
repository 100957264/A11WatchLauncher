...
public class ClockSkinConst {
    ...
    public static final int ARRAY_DAY_NEW= 38;//add 2017/04/11
    public static final int ARRAY_SECOND_NEW= 39;//add 2017/04/11
    public static final int ARRAY_STEPS_NEW= 40;//add 2017/04/11
    public static final int ARRAY_KCAL_NEW= 41;//add 2017/04/11

    public static final int ARRAY_STEPS_CIRCLE_NEW= 42;//add 2017/04/12
    public static final int ARRAY_BATTERY_CIRCLE_NEW= 43;//add 2017/04/12
